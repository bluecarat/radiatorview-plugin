...
public class CoberturaLineCoverageResult {
	...
	/**
	 * Constructor.
	 * @param lineCoverage of a build
	 * @param lineCoverageDiff difference of the line coverage of two sequent builds
	 */
	public CoberturaLineCoverageResult(float lineCoverage,
			float lineCoverageDiff) {
